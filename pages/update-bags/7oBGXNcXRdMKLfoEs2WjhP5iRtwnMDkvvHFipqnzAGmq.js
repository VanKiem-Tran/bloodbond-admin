							...
							<div className='card-body'>
								...
								<div className='p-1'>
									<form>
										...
										<label className='pb-2 mt-4 pl-5'>
											File:{' '}
										</label>
					...
					{updated && (
						<div>
							...
							<div className='m-3 text-center'>
								<h6 className='p-2'>
									NFTs take a bit of time to update. Check
									This NFT after 10 minutes to ensure that it
									has updated
								</h6>
								<a
									href={`/list-details?token_address=${tokAddr}&network=${network}`}
